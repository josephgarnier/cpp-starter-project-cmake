...
#   ``<CURRENT_TARGET_NAME>`` and configured with the setting ``rulesFile: generic``.
...
#   listed in "Input". The value of a variable associated with a setting not
#   declared in the configuration JSON file is "NOT DEFINED".
#
# Environment read:
...
#
# Returns:
#   <DEP_NAME>_FOUND: Final status "1" if found, "0" if not found. The command
#                     find_package() can initialize this variable.
#
# Usage:
...
# Try to find the dependency in local and common directories, or download it if
# not found
