...
macro(debug_dump_variables)
	...
	foreach (variable_name IN ITEMS ${variable_names})
		if((NOT DBDV_EXCLUDE_REGEX) OR (NOT "${variable_name}" MATCHES "${DBDV_EXCLUDE_REGEX}"))
