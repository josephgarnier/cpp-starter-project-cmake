...
dependency(IMPORT "<my-library-name>"
  SHARED
  RELEASE_NAME "<release-raw-filename>" # Should be a filename wihtout its version numbers and suffix. Can be empty.
  DEBUG_NAME "<debug-raw-filename>" # Should be a filename wihtout its version numbers and suffix. Can be empty.
